...
```
#
## Transfer learning (Not yet implementation)
...
On image:
``` shell
python detect.py --weights <saved_models_path> --conf 0.25 --img-size 1024 --device 6 --source <demo_dataset_path>
```
...
* [https://github.com/hukaixuan19970627/yolov5_obb](https://github.com/hukaixuan19970627/yolov5_obb)

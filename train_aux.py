...
from utils.loss import ComputeLoss, ComputeLossAuxOTA, Polygon_ComputeLoss
from utils.plots import plot_images, plot_labels, polygon_plot_labels, plot_results, plot_evolution, polygon_plot_images
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        for i, (imgs, targets, paths, _) in pbar:  # batch -------------------------------------------------------------
            ...
            if rank in [-1, 0]:
                ...
                if plots and ni < 10:
                    ...
                    Thread(target=plot_model, args=(imgs, targets, paths, f), daemon=True).start()
                    # if tb_writer:
        ...
        if rank in [-1, 0]:
            ...
            if not opt.notest or final_epoch:  # Calculate mAP
                ...
                results, maps, times = poly_test.test(data_dict,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str, help='source of tif files')
    ...
    if opt.divide:
        split_set(opt.img_size[0], datatype=opt.data.split('/')[-1][:-5], source=opt.source)

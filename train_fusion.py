...
import poly_test_fusion  # import test.py to get mAP after each epoch
import test
from models.experimental import attempt_load
from models.yolo_fusion import Model, Polygon_Model
...
def train(hyp, opt, device, tb_writer=None, polygon=False):
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        Test = poly_test_fusion if polygon else test
        ...
        if rank in [-1, 0]:
            ...
            # Log
            tags = ['train/box_loss', 'train/obj_loss', 'train/cls_loss', 'train/box_cross_loss', 'train/obj_cross_loss', 'train/cls_cross_loss',  # train loss

...
import torch
import models.gan as gan_models
import data.gan_data as gan_data
...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        #parser.add_argument('--checkpoints_dir', type=str, default='./gan_checkpoints', help='models are saved here')
        # model parameters
        ...
        parser.add_argument('--load_size', type=int, default=640, help='scale images to this size') # 286
        parser.add_argument('--crop_size', type=int, default=640, help='then crop to this size') # 256
    ...
    def gather_options(self):
        ...
        print(model_name)
        model_option_setter = gan_models.get_option_setter(model_name)
        parser = model_option_setter(parser, self.isTrain)
        opt, _ = parser.parse_known_args()  # parse again with new defaults

        # modify dataset-related parser options
        dataset_name = opt.dataset_mode
        dataset_option_setter = gan_data.get_option_setter(dataset_name)

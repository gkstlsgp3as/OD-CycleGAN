import torch
import itertools
from utils.gan_utils.image_pool import ImagePool # add CycleGAN from root
from .base_model import BaseModel
from . import networks
import numpy as np
from torch import is_tensor
from utils.gan_utils import util # add CycleGAN from root
...
class CycleGANModel(BaseModel):
    ...
    def save_image(self, image_path, im):
        im = util.tensor2im(im)
        util.save_image(im, image_path)
        #from tifffile import imwrite
        #image_numpy = self.to_image(im)
